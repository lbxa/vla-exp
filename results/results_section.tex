...
This section presents a comprehensive evaluation of the proposed residual reinforcement learning framework across seven manipulation tasks. We systematically compare the frozen base policy ($\pi_{\text{base}}$), three pure \ac{RL} algorithms (TD3, SAC, PPO), and their corresponding residual variants (Res-TD3, Res-SAC, Res-PPO). All experiments were conducted over 20 trials per task, with trials 1--10 under nominal conditions and trials 11--20 under \ac{OOD} conditions featuring randomized initialization and dynamics perturbations.
